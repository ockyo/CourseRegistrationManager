...
public class HomeFrm extends javax.swing.JFrame implements ActionListener {
    ...
    public HomeFrm() {
        ...
        subjects = new Database().readDataSubject();
        tableModelSubject = (DefaultTableModel) tblSubject.getModel();
        showSubjects();

        students = new Database().readDataStudent();
        tableModelStudent = (DefaultTableModel) tblStudent.getModel();
        showStudents();
        
        registerings = new Database().readDataRegistering();
    ...
    private void editSubject() {
        int selectedIndex = tblSubject.getSelectedRow();
        if (selectedIndex != -1) {
            Subject oldSubject = subjects.get(selectedIndex);
            EditSubjectDialog editSubjectDialog
                    = new EditSubjectDialog(this, rootPaneCheckingEnabled, oldSubject);
            editSubjectDialog.setVisible(true);
        } else {
            JOptionPane.showMessageDialog(rootPane, "Vui lòng chọn 1 môn học để chỉnh sửa!");
        }
    }
    ...
    private void removeSubject() {
        ...
        if (selectedIndex != -1) {
            ...
            int confirm = JOptionPane.showConfirmDialog(rootPane, "Bạn có chắc chắn muốn xóa môn học này không?");
            if (confirm == JOptionPane.YES_OPTION) { // or OK_OPTION
                if (new Database().removeSubject(subject) != -1) {
                }
            ...
            JOptionPane.showMessageDialog(rootPane, "Vui lòng chọn 1 môn học để xóa!");
        }
    }
    ...
    private void searchSubjects() {
        if (rbSearchSubjectByName.isSelected()) {
            ...
            if (key.isEmpty()) {
                JOptionPane.showMessageDialog(rootPane, "Vui lòng nhập tên môn học cần tìm kiếm!");
            } else {
            ...
            if (!fromValString.isEmpty() && !toValString.isEmpty()) {
                ...
                JOptionPane.showMessageDialog(rootPane, "Vui lòng nhập đoạn giá trị của số"
    ...
    private void checkAndShowSearchResult() {
        if (subjects.size() > 0) {
            showSubjects();
            JOptionPane.showMessageDialog(rootPane, "Tìm thấy " + subjects.size() + " kết quả");
        } else {
            subjects.clear();
            showSubjects();
    ...
    private void refreshSubjects() {
        ...
        subjects.clear();
        subjects.addAll(new Database().readDataSubject());
        showSubjects();
    }

    // ================= Quản lý sinh viên =================
    // 2 hàm để hiện danh sách sinh viên
    ...
    private void removeStudent() {
        ...
        if (selectedIndex != -1) {
            ...
            if (confirm == JOptionPane.YES_OPTION) { // or OK_OPTION
                if (new Database().removeStudent(student) != -1) {
                }
            ...
            JOptionPane.showMessageDialog(rootPane, "Vui lòng chọn 1 sinh viên để xóa!");
        }
    }
    ...
    private void editStudent() {
        ...
        if (selectedIndex != -1) {
            Student oldStudent = students.get(selectedIndex);
            var editStudentDialog = new EditStudentDialog(this, true, oldStudent);
            editStudentDialog.setVisible(true);
        } else {
            JOptionPane.showMessageDialog(rootPane,
                    "Vui lòng chọn 1 sinh viên cụ thể trong bảng để sửa!");
        }
    }
    ...
    // Các hàm sắp xếp và tìm kiếm trong danh sách sinh viên
    // Sắp xếp
    ...
    private void searchStudents() {
        ...
        if (rbSearchStudentId.isSelected()) {
            ...
            if (key.isEmpty()) {
                JOptionPane.showMessageDialog(rootPane, "Vui lòng nhập mã sinh viên cần tìm kiếm!");
            } else {
            ...
            if (!name.isEmpty()) {
                ...
                JOptionPane.showMessageDialog(rootPane, "Vui lòng nhập tên sinh viên cần tìm kiếm!");
            }
            ...
            if (!major.isEmpty()) {
                ...
                JOptionPane.showMessageDialog(rootPane,
                        "Vui lòng chọn chuyên ngành sinh viên cần tìm kiếm!");
            }
        } else {
            JOptionPane.showMessageDialog(rootPane, "Vui lòng chọn tiêu chí tìm kiếm trước!");
        }
    ...
    private void checkAndShowSearchStudentResult() {
        if (students.size() > 0) {
            showStudents();
            JOptionPane.showMessageDialog(rootPane, "Tìm thấy " + students.size() + " kết quả");
        } else {
            students.clear();
            showStudents();
            JOptionPane.showMessageDialog(rootPane, "Không tìm thấy kết quả nào!");
    ...
    // Làm mới lại danh sách sinh viên
    ...
    private void reloadStudent() {
        students.clear();
        students.addAll(new Database().readDataStudent());
    }

    // ================= Quản lý đăng ký môn học =================
    
    // Hiện dữ liệu các bảng đăng ký môn học
    ...
    private void removeRegistering() {
        ...
        if (index > -1) {
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                if (new Database().removeRegistering(registerings.get(index)) != -1) {}
                tableModelRegistering.removeRow(index);
                registerings.remove(index);
            }
        } else {
            JOptionPane.showMessageDialog(rootPane, "Vui lòng chọn 1 bản đăng ký để xóa!");
        }
    }
    ...
    private void searchRegistering() {
        ...
        if (rbSearchReByRegisterTime.isSelected()) {
            ...
            if (fromStr.isEmpty() || toStr.isEmpty()) {
                JOptionPane.showMessageDialog(rootPane, "Vui lòng nhập đầy đủ ngày đăng "
                ...
                try {
                    ...
                    showRegisterings();
                    JOptionPane.showMessageDialog(rootPane, "Tìm thấy " + registerings.size() + " kết quả.");
                } catch (ParseException ex) {
                    JOptionPane.showMessageDialog(rootPane, "Vui lòng nhập đúng định dạng dd/MM/yyyy.\n"
                            + "Ví dụ: 25/01/2025");
                }
            }
            ...
            if (name.isEmpty()) {
                JOptionPane.showMessageDialog(rootPane, "Vui lòng nhập tên sinh viên để tìm kiếm");
            } else {
                registerings.clear();
                registerings.addAll(
            ...
            JOptionPane.showMessageDialog(rootPane, "Vui lòng chọn phương thức tìm kiếm trước tìm.");
        }
    }
    
    private void reloadRegisterings() {
        registerings.clear();
        registerings.addAll(new Database().readDataRegistering());
    }
