...
public class EditStudentDialog extends javax.swing.JDialog implements ActionListener {
    ...
    public EditStudentDialog(java.awt.Frame parent, boolean modal, Student oldStudent) {
        this(parent, modal);
    ...
    private void editStudent() {
        if (new Database().removeStudent(oldStudent) != -1) {
        }
        ...
        if (pId.isEmpty() || fullName.isEmpty() || dobStr.isEmpty()
            ...
            try {
                ...
                newStudent.setId(pId);
                newStudent.setFullName(fullName);
                newStudent.setAddress(address);
                newStudent.setDob(dobStr);
                ...
                homeFrm.editStudentCallback(newStudent);
                if (new Database().addStudent(newStudent) != -1) {}
                ...
                var msg = "Mã sinh viên chỉ có chữ và số, tối đa 10 ký tự.";
                showMessage(ex.getMessage() + "\n" + msg);
            } catch (InvalidPersonIdException ex) {
                var msg = "Số CCCD không hợp lệ";
                showMessage(ex.getMessage() + "\n" + msg);
            }
        }
    }
    ...
    private void showData() {
        ...
        txtPersonId.setText(oldStudent.getId());
        txtPersonName.setText(oldStudent.getFullName());
        txtPersonDob.setText(dateFormat.format(oldStudent.getDob()));
        txtPersonAddress.setText(oldStudent.getAddress());
        txtPersonId.setText(oldStudent.getId());
        txtPersonEmail.setText(oldStudent.getEmail());
        txtPersonPhoneNumber.setText(oldStudent.getPhoneNumber());
        txtStudentId.setText(oldStudent.getStudentId());
        txtStudentClass.setText(oldStudent.getStudentClass());
        txtSchoolYear.setText(oldStudent.getSchoolYear());
        ...
        for (int i = 0; i < comboxModel.getSize(); i++) {
            if (comboxModel.getElementAt(i).compareTo(oldStudent.getMajor()) == 0) {
